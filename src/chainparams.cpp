...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000c88405444a0bcb10e3b1040afe54246a5e0a2f74157d0d75d2a8d0d586f"))
	(1, uint256("000009eed3f6eb527c94f9c0027be14ce46ddde2a8bb2d057d6721f1228a87be"))
	(2, uint256("000006ae1f4424fcaec0a1e84c2aa46fe357abfef6af2ba9c4a16466ff48e327"))
    (3, uint256("000008dc1951da358cc4884b0e9ec93eb84f82bc35cf79bce176e77930f96b73"))
    (4, uint256("00000dab184bd08ce8011c09946c3ac081cf2ad663371d18cf0223308d9a908e"))
    (5, uint256("00000f728f9ffb5d7fc1e71d7204a0dc97a429b3c8d974a4b90bdb2ecadf311d"))
    (10, uint256("0000065ad056df6aa6d9c130f8196e453f5e64fd67874c7b2718bf0a0864216d"))
    (3049, uint256("0000000000086d606803dfeefa4c4c31a34b848aac9c1b7cd0d0a71da491f634"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 41368;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Radarcoin starting difficulty is 1 / 2^12
        ...
        nEnforceNewSporkKey = 1;
        nRejectOldSporkKey = 1; 
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "RadarCoin Official Launch";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1594712349;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 322686;
        hashGenesisBlock = genesis.GetHash();
        
        assert(hashGenesisBlock == uint256("0x00000c88405444a0bcb10e3b1040afe54246a5e0a2f74157d0d75d2a8d0d586f"));
        assert(genesis.hashMerkleRoot == uint256("0x063b8391b4ccc8bca860da4ee3940b36c7f93ab4fae5cbbc512c1b2621ad5d34"));

        vSeeds.push_back(CDNSSeedData("45.61.139.188", "45.61.139.188"));
        vSeeds.push_back(CDNSSeedData("45.61.138.129", "45.61.138.129"));
	vSeeds.push_back(CDNSSeedData("45.61.138.203", "45.61.138.203"));
	vSeeds.push_back(CDNSSeedData("45.61.138.110", "45.61.138.110"));
        ...
        strSporkKey = "0396a355c7ce7bd127d6fe3761fbd889b3d83964845ac34b3f745a59c6935a8048";
        strSporkKeyOld = "0396a355c7ce7bd127d6fe3761fbd889b3d83964845ac34b3f745a59c6935a8048";
        strObfuscationPoolDummyAddress = "RLdPzxpjNFGeU2g4fexGDYYnNvwQrbNxZq";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zradar to be stakable
...
public:
    CTestNetParams()
    {
        ...
        // Testnet radarcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Radarcoin: 1 day
        nTargetSpacing = 1 * 60;        // Radarcoin: 1 minutes
